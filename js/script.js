...
const colorsOverlay = [
  ...
  'rgba(226, 65, 65, 0.5)',
  'rgba(78, 65, 226, 0.5)',
]; //order = orange[0],green[1],purple[2],red[3],blue[4]
...
const shopItems = [
  {
    imageSrc:
      'https://personal-static-files-cdn.fra1.cdn.digitaloceanspaces.com/TOBIS/caderno.jpg',
    description:
  ...
  {
    imageSrc:
      'https://personal-static-files-cdn.fra1.cdn.digitaloceanspaces.com/TOBIS/tape%20mockup.jpg',
    description:
  ...
  {
    imageSrc:
      'https://personal-static-files-cdn.fra1.cdn.digitaloceanspaces.com/TOBIS/PAPER%20BAG.jpg',
    description:
  ...
  {
    imageSrc:
      'https://personal-static-files-cdn.fra1.cdn.digitaloceanspaces.com/TOBIS/toolbag.jpg',
    description:
  ...
  {
    imageSrc:
      'https://personal-static-files-cdn.fra1.cdn.digitaloceanspaces.com/TOBIS/T-shirt%202.jpg',
    description:
  ...
  {
    imageSrc:
      'https://personal-static-files-cdn.fra1.cdn.digitaloceanspaces.com/TOBIS/T-shirt%201.jpg',
    description:
      'Introducing our Organic Cotton T-Shirt, a sustainable and conscious choice for your wardrobe. Crafted from 100% organic cotton, this shirt embodies a commitment to both comfort and environmental responsibility. Grown without synthetic pesticides or fertilizers, organic cotton promotes soil health and reduces the environmental impact associated with conventional cotton.',
    subtitle: '250gsm organic cotton',
  },
  {
    imageSrc:
      'https://personal-static-files-cdn.fra1.cdn.digitaloceanspaces.com/TOBIS/calendario.jpg',
    description:
  ...
  {
    imageSrc:
      'https://personal-static-files-cdn.fra1.cdn.digitaloceanspaces.com/TOBIS/Steel%20Mugs%20Minimalistic%20Mockup.jpg',
    description:
...
for (let i = 0; i < photoOver.length; i++) {
  //overlay color for the blocks on the artist page
  photoOver[i].addEventListener('mouseover', () => {
    photoOver[i].style.opacity = '100%';
    if (i <= 3) {
      //defining the block color depending on row
...
for (let i = 0; i < shopOver.length; i++) {
  //overlay color for the blocks on the shop page
  ...
  const addToCheckout = () => {
    localStorage.setItem(
      'imgSrc' + currentIndex.toString(),
      shopItems[currentIndex].imageSrc
    );
    localStorage.setItem(
      'title' + currentIndex.toString(),
      itemName[currentIndex].innerText
    );
    localStorage.setItem(
      'subTitle' + currentIndex.toString(),
      shopItems[currentIndex].subtitle
    );
    localStorage.setItem(
      'price' + currentIndex.toString(),
      itemPriceP[currentIndex].innerText
    );
...
function create(tag, text, className) {
  // function that allows us to create tags and add an inner text and class name if needed
...
function checkoutMechanic() {
  ...
  for (let i = 0; i < localStorage.length / 4; i++) {
    // localStorage.length / 4 because every item has 4 items stored
...
window.addEventListener('load', function () {
  if (!window.location.pathname.endsWith('checkout.html')) {
    //so the add to cart function doesnt mess with the checkout mechanic
    addToCart();
  }
});
